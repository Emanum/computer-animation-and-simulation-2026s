...
function toCdnImportMap(threeVersion) {
  return `  <script type="importmap">\n      {\n        "imports": {\n          "three": "https://cdn.jsdelivr.net/npm/three@${threeVersion}/build/three.module.js",\n          "three/webgpu": "https://cdn.jsdelivr.net/npm/three@${threeVersion}/build/three.webgpu.js",\n          "three/tsl": "https://cdn.jsdelivr.net/npm/three@${threeVersion}/build/three.tsl.js",\n          "three/addons/": "https://cdn.jsdelivr.net/npm/three@${threeVersion}/examples/jsm/"\n        }\n      }\n  </script>`;
}
...
async function build() {
  ...
  const submissionImportMap = toCdnImportMap(threeVersion);
