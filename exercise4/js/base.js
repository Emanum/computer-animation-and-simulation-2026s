...
export class ExerciseBase {
    ...
    constructor(useWebGPU = false) {
        this.initScene();
        this.initRenderer(document.getElementById("container"), useWebGPU);
        this.initCamera();
     ...
     * @param {boolean} useWebGPU uses THREE.WebGPURenderer if true, otherwise THREE.WebGLRenderer
     */
    initRenderer(container, useWebGPU = false) {
        if (useWebGPU) {
    ...
    raycastPointerAgainst(event, objects, shouldReturnAll = false) {
